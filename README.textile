...
bc. gem 'mongoid_taggable', git: 'https://github.com/stephenkey/mongoid_taggable.git'
...
p. Weighted tags with order and limit

bc.. Post.tags_with_weight('asc', 10)
